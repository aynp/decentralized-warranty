...
export default function BuyModal({onRequestClose}:{onRequestClose:any}) {
  return (
    <div className="">
        ...
        xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-red-500 hover:scale-120 duration-200 ease-in-out cursor-pointer">
